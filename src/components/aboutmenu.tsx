...
export default function AboutMenu() {
  return (
    <div className="flex flex-col pt-6 px-4 max-w-screen-lg mx-auto">
      ...
      {/* Menu Categories */}
      <div className="flex flex-wrap gap-4 justify-center mt-6 text-lg md:text-xl leading-snug text-neutral-600">
        {menuCategories.map((category, index) => (
          <div
            key={index}
            className={`cursor-pointer px-3 py-1 rounded-full ${
              category.isActive ? 'text-amber-500 bg-neutral-200' : 'text-neutral-600 bg-neutral-100'
